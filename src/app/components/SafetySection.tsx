  ...
  return (
    <div className="mx-auto" style={{ maxWidth: 960 }}>
      <div className="text-center mb-6">
        ...
        <p className="font-eloquia text-base mt-1" style={{ color: '#475466' }}>Clear, simple safeguards you can see.</p>
      </div>
      ...
      <div className="mt-6 rounded-2xl border border-white/60 bg-white p-5">
        ...
        <div className="flex items-center justify-between flex-wrap gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="font-poppins text-sm px-4 py-2 rounded-full" style={{ background: '#1b70db', color: '#fff' }}>Continue</button>
          </div>
        </div>
      </div>
    </div>
