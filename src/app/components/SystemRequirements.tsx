  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="text-center mb-6">
        ...
        <p className="font-eloquia text-base mt-1" style={{ color: '#475466' }}>Everything you need is installed once.</p>
      </div>
      <div className="grid md:grid-cols-2 gap-4">
        {items.map((b) => (
          <div key={b.h} className="rounded-2xl border border-white/60 bg-white p-5">
            ...
            <div className="font-eloquia text-base mt-1" style={{ color: '#475466' }}>{b.d}</div>
          </div>
        ))}
      </div>
      <div className="text-center mt-4">
        <span className="font-poppins text-[12px] rounded-full px-3 py-1" style={{ background: '#ffffff', color: '#475466', border: '1px solid #E8EFF8' }}>Not affiliated with OpenAI or Anthropic</span>
      </div>
    </div>
  );
}
